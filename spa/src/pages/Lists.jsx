  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in">
      <div className="mb-10">
        ...
        <p className="mt-2 text-lg text-gray-600">Organize your contacts into lists for targeted campaigns</p>
      </div>
      ...
      <div className="card-glow bg-gradient-to-br from-white to-gray-50 rounded-xl shadow-lg border border-gray-100 mb-8">
        ...
        {showCreateForm && (
          <div className="px-6 py-5 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
            <form onSubmit={handleCreateList} className="flex flex-col sm:flex-row sm:items-center space-y-4 sm:space-y-0 sm:space-x-4">
              <input
                type="text"
                placeholder="List name..."
                className="form-input flex-1 py-3 px-4 text-base border-gray-200 focus:border-blue-500 focus:ring-blue-500 rounded-lg"
                value={newListName}
              ...
              <div className="p-6">
                ...
                <div className="mt-6 space-y-3">
                  <div className="flex items-center text-gray-600">
                    ...
                    <span className="text-lg font-semibold">{list.contactCount} contacts</span>
                  </div>
                  ...
                  <div className="flex items-center text-gray-600">
                    ...
                    <span className="text-lg font-semibold">Updated {list.lastUpdated}</span>
                  </div>
                </div>
      ...
      {lists.length === 0 && !isLoading && (
        <div className="text-center py-16">
          ...
          <h3 className="mt-4 text-xl font-semibold text-gray-900">No contact lists</h3>
